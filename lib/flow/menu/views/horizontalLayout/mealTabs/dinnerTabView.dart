...
class DinnerTabView extends StatefulWidget {
  final String? menuType;
  const DinnerTabView({Key? key, this.menuType}) : super(key: key);

  @override
  State<DinnerTabView> createState() => _DinnerTabViewState();
}

class _DinnerTabViewState extends State<DinnerTabView> {
