...
class LunchTabView extends StatefulWidget {
  final String? menuType;
  const LunchTabView({Key? key, this.menuType}) : super(key: key);

  @override
  State<LunchTabView> createState() => _LunchTabViewState();
}

class _LunchTabViewState extends State<LunchTabView> {
